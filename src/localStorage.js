...
export const loadFromStorageToState = () => { // local storage theke load kore state ee ana.
    try {
  ...
  export const saveToStorageFromState = (state) => {    // state theke asha data gulo store
    try {
